...
/**
 * A basic implementation of an RTP socket_video.
...
public class RtpSocket implements Runnable {
	...
	/**
	 * This RTP socket_video implements a buffering mechanism relying on a FIFO of buffers and a Thread.
	 * @throws IOException
	 */
	public RtpSocket() {
	...
	/** Closes the underlying socket_video. */
	public void close() {
		mSocket.close();
	}
