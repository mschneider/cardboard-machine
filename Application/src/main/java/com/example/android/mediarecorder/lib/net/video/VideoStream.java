...
public abstract class VideoStream extends MediaStream {
	...
	protected void encodeWithMediaRecorder() throws IOException, ConfNotSupportedException {
		...
		// We need a local socket_video to forward data output by the camera to the packetizer
		createSockets();
		...
		try {
			...
			// We write the output of the camera in a local socket_video instead of a file !
			// This one little trick makes streaming feasible quiet simply: data from the camera
			// can then be manipulated at the other end of the socket_video
